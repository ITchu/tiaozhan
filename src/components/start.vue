  ...
  <div class="start">
    ...
    <main v-else-if="status==3" class="three">
        <div class="answer">
          ...
          <div :class="{topic:true,zoomIn:zoomIn,zoomOut:zoomOut}" class="animated">
            <p>{{question_title}}</p>
            <ul class="result">
    ...
    <div v-if="wrong==2" class="opportunity">
      ...
      sockets:{
        ...
        question: function(data) {
          ...
          if(this.result==1||this.result==2){
            ...
            this.click=true;
            if(y==1){
              this.isActive==data.right_answer;
...
.revived>.wrong>img,.revived>.opportunity>img{
    position: absolute;
    right: 0.38rem;
    top: 0.3rem;
    width: 0.3rem;
